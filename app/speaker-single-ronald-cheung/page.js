            ...
            <div className="col-xl-6 col-lg-7">
              <div className="speaker-single__left">
                <div className="section-title text-left">
                  ...
                  <span>Mr. Ronald Cheung</span></h2>
                  <h2 className="section-title__title" style={{fontSize:'100%'}}>
                  <p>Founder & Chief Executive Officer, Lifewood Data Technology Limited</p>
                  </h2>
                </div>
                <div className="speaker-single__info-box">
                  <ul className="speaker-single__info-list list-unstyled" style={{fontSize:'100%'}}>
                  <p>Ronald Cheung is the Founder and CEO of Lifewood Data Technology. With extensive experience in AI, data technology, and business expansion, Ronald has successfully led Lifewood through its transformation, focusing on social responsibility and governance while driving global growth. He is passionate about creating value through innovative AI solutions while ensuring that Lifewood’s expansion is aligned with sustainable business practices.</p>  
                  </ul>
                </div>
            </div>
          </div>
