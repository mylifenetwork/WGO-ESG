          ...
          <div className="row">
            ...
            >
              <div className="speaker-page__single">
                <div className="speaker-page__img-box">
                  <div className="speaker-page__img">
                    <a href=""><img src="assets/images/speakers/cloris_cai.jpg" style={{height: '418px'}} alt /></a>
                  </div>
                  <div className="speaker-page__img-shape" />
                </div>
                <div className="speaker-page__content">
            ...
            >
              <div className="speaker-page__single">
                <div className="speaker-page__img-box">
                  <div className="speaker-page__img">
                    <a href=""><img src="assets/images/speakers/jean_sebastien_jacquetin.jpg" style={{height: '418px'}} alt /></a>
                  </div>
                  <div className="speaker-page__img-shape" />
                </div>
                <div className="speaker-page__content">
